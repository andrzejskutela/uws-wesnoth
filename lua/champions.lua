local find_conditional_buffs = function(pool_settings)
	...
	if pool_settings['has_ranged'] then
		for k,v in ipairs({ 'A28','A35','A38','A39','A42','A48','A50', 'B3','B7','B28', 'C8', }) do segregation_pool[#segregation_pool + 1] = v end
	...
	if pool_settings['has_melee'] then
		for k,v in ipairs({ 'A2','A6','A21','A31','A33','A34','A41','A45','A47','A49','A54', 'B2','B4','B6','B9','B27','B30','B33','B41', 'C7','C10','C14','C20','C25','C39', }) do segregation_pool[#segregation_pool + 1] = v end
	...
	if pool_settings['is_lawful'] then
		for k,v in ipairs({ 'A58','A58' }) do segregation_pool[#segregation_pool + 1] = v end
	end
...
local early_allowed_buffs_table = { 
	'A1','A3','A6','A7','A8','A9','A11','A12','A13','A15','A16','A18','A19','A22','A23','A24','A25','A28','A29','A31','A39','A47','A48','A49','A50','A51','A52','A53','A54','A57','A58',
	'B1','B6','B11','B12','B13','B17','B19','B21','B23','B24','B25','B26','B27','B28','B39','B45','B46','B47','B48','B49','B50','B52','B56','B57',
...
function wesnoth.wml_actions.qquws_generate_random_champion(cfg)
	...
	local pool_b = { 'B1','B10','B11','B12','B14','B15','B16','B18','B19','B21','B22','B24','B25','B29','B32','B35','B45','B46','B47','B48','B49','B50','B52','B56','B57', }
