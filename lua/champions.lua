local find_conditional_buffs = function(pool_settings)
	...
	if pool_settings['has_melee'] then
		...
		if pool_settings['has_magical_melee'] then
			...
			for k,v in ipairs({ 'A9','A15','A20','A24','A30', 'B23', 'C5','C6','C12','C19','C23','C27','C30','C41', }) do segregation_pool[#segregation_pool + 1] = v end
		end
		...
		if pool_settings['has_melee_charge'] then
			...
			for k,v in ipairs({ 'C42', }) do segregation_pool[#segregation_pool + 1] = v end
		end
	end
...
local allowed_buffs_table = { 
	'A1','A3','A6','A7','A8','A9','A11','A12','A13','A15','A16','A18','A19','A22','A23','A24','A25','A28','A29','A31','A39','A47','A48','A49','A50',
...
local restrict_op_buffs = function(pool)
	local ret = {}
	local test_array = {}
	for k,v in ipairs(allowed_buffs_table) do
		test_array[v] = true
	end
...
function wesnoth.wml_actions.qquws_generate_random_champion(cfg)
	...
	local pool_settings = {
		['has_ranged'] = wesnoth.get_variable("new_unit_has_ranged_attack"),
		['has_melee'] = wesnoth.get_variable("new_unit_has_melee_attack"),
		['has_magical_ranged'] = wesnoth.get_variable("has_magical_ranged"),
		['has_magical_melee'] = wesnoth.get_variable("has_magical_melee"),
		['is_static'] = wesnoth.get_variable("unit_is_static"),
		['has_melee_pierce'] = wesnoth.get_variable("has_melee_pierce"),
		['has_melee_charge'] = wesnoth.get_variable("has_melee_charge"),
		['has_physical_resistances'] = wesnoth.get_variable("has_physical_resistances"),
		['has_berserk'] = wesnoth.get_variable("has_berserk"),
		['is_high_level'] = wesnoth.get_variable("is_high_level"),
		['has_strong_melee_blade'] = wesnoth.get_variable("has_strong_melee_blade"),
		['has_strong_impact'] = wesnoth.get_variable("has_strong_impact"),
		['has_overwhelming_melee_blade'] = wesnoth.get_variable("has_overwhelming_melee_blade"),
	}
